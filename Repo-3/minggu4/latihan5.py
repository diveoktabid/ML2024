...
reza = Siswa("14202", "Dive", "Cirebon")
adip = SiswaSMK("14203", "Adip", "Semarang", "Rekayasa Perangkat Lunak")
...
m1 = Manager(1234,"Mehta","Dive",5000,9000)
print(m1.getName())
